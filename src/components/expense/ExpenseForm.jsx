...
const emptyForm = { date: todayISO(), category: EXPENSE_CATEGORIES[0], amount: '', note: '' };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={initialData ? 'Edit Expense' : 'Add Expense'}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Textarea label="Note (optional)" placeholder="e.g. Monthly rent" value={form.note} onChange={(e) => setForm({ ...form, note: e.target.value })} />
